...
class Llama2(nn.Module):
    """LLaMA 2 decoder-only language model.

    Based on Touvron et al. (2023): "Llama 2: Open Foundation and Fine-Tuned Chat Models".
    Key Features:
    - Extended context length (4096 tokens by default)
    - Grouped-Query Attention (GQA) with flexible n_kv_heads
