...
from nnfs.layers import Dropout, Embedding, Linear, TiedLinear
from nnfs.modules import GPT1TransformerBlock
...
class GPT1(nn.Module):
    def __init__(self, config: GPT1Config | None = None):
        ...
        self.blocks = nn.ModuleList(
            [
                GPT1TransformerBlock(config.d_model, config.n_heads, config.d_ff, config.dropout)
